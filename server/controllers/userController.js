...
userController.post('/login', async (req, res, next) => {
    try {
        ...
        res.cookie('jwtHeaderPayload', cookies.userInfo, {sameSite: 'none', secure: true});
        res.cookie('jwtSignature', cookies.signature, { httpOnly: true, sameSite: 'none', secure: true});
